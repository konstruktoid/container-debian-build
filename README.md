...
```sh
$ sudo sh buildeb.sh bookworm http://deb.debian.org/debian "$(pwd)/buildarea"
$ docker build -t konstruktoid/debian -f Dockerfile.bookworm .
...
docker run --privileged -v "$(pwd)":/opt/buildarea konstruktoid/debianbuild \
